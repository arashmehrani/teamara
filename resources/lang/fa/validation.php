...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'site_description' => 'معرفی کوتاه',
        'post_permalink' => 'پیشوند آدرس مطالب',
        'category_permalink' => 'پیشوند آدرس دسته ها',
        'posts_per_page' => 'تعداد پست',
        'users_can_register' => 'امکان ثبت نام',
        'users_can_comment' => 'امکان ثبت نظر',
        'comment_registration' => 'تایید نظر',
        'admin_email' => 'ایمیل سایت',
        'mailserver_url' => 'سرور ایمیل',
        'mailserver_login' => 'نام کاربری ایمیل',
        'mailserver_pass' => 'پسورد ایمیل',
        'mailserver_port' => 'پورت ایمیل',
        'mailserver_encryption' => 'رمزگذاری ایمیل',
        'parent_id' => 'دسته مادر',
        'slug' => 'نامک',
