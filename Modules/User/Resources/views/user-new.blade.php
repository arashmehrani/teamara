...
@section('title')
    <title>افزودن کاربر جدید > {{config('app.name')}}</title>
@endsection
@section('css')
    ...
    <div class="row row-sm">
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
            <div class="card custom-card">
                <div class="card-body">
                    <div>
                        <h6 class="main-content-label mb-1">افزودن کاربر جدید</h6>
                        <p class="text-muted card-sub-title">کاربر جدیدی بسازید و آن را به سایت اضافه کنید.</p>
                    </div>
